...
NameCard::NameCard(const NameCard& Name)
{
	this->name = new char[strlen(Name.name) + 1];
	this->company = new char[strlen(Name.company) + 1];
	this->phone = new char[strlen(Name.phone) + 1];
	strcpy(this->name, Name.name);
	strcpy(this->company, Name.company);
	strcpy(this->phone, Name.phone);
